<?php
	...
	$res = getArray("select *, date_format(doc_date,'%m/%d/%Y') as d8 from arbeg_header where doc_no = '1' and company = '$_SESSION[company]' and branch = '$_SESSION[branchid]';");
	...
	function setHeaderControls($status,$doc_no,$uid,$dS) {
		...
		switch($status) {
			case "Posted":
				list($posted_by,$posted_on) = getArray("select fullname as name, date_format(updated_on,'%m/%d/%Y %p') as date_posted from arbeg_header a left join erp_commo.user_info b on a.updated_by=b.emp_id where a.doc_no='$doc_no';");
				if($urights == "admin") {
					$headerControls = "<button type=button onclick=\"javascript: reOpenARB();\"><img src='images/icons/edit.png' align=absmiddle width=16 height=16 />&nbsp;Set this Document to Active Status</button>&nbsp;<button  onClick=\"javascript:reprintJV('$doc_no','$_SESSION[userid]');\"><img src=\"images/icons/print.png\" width=16 height=16 border=0 align=\"absmiddle\">&nbsp;Reprint Journal Voucher</button>";
				} else { echo "<b>Posted By:</b> $posted_by  <b>::  Posted On:</b> $posted_on"; }
			break;
			case "Active": default:
				$headerControls = "<button  onClick=\"javascript:finalizeARB();\"><img src=\"images/icons/print.png\" width=16 height=16 border=0 align=\"absmiddle\">&nbsp;Finalize & Post AR Beginning</button>&nbsp;<button onclick=\"javascript:saveARBHeader();\"><img src=\"images/save.png\" width=16 height=16 border=0 align=\"absmiddle\">&nbsp;Save Changes</button>&nbsp;";
			break;
		}
		echo $headerControls;
	}
		...
		<tr>
			<td valign=top >
				...
				<table width=98% cellpadding="0" cellspacing="0" align=center style="border: 1px solid #436178;">
					<tr>
						<td align=left class="gridHead">ACCOUNTS RECEIVABLE BEGINNING BALANCE</td>
						...
						<td width="100%" colspan=2>
							<table border="0" cellpadding="0" cellspacing="1" width=100%>
								...
								<tr>
									...
									<td align=left>
										<textarea rows=2 type="text" id="remarks" style="width:80%;" <?php if($res['status'] == "Active") { echo "onblur=\"saveARBHeader();\" "; } echo $isReadOnly; ?>><?php echo $res['explanation']; ?></textarea>
									</td>
								</tr>
								<tr><td height=4></td></tr>
							</table>
					...
					<tr>
						<td colspan=2>
							<table cellspacing=0 cellpadding=0 border=0 width=100%>
								<tr bgcolor="#887e6e">
									<td align=left class="gridHead" width="10%" style="padding-left: 10px;">CLIENT CODE</td>
									<td align=left class="gridHead" width="35%">CLIENT NAME</td>
								...
								<tr bgcolor="ededed">
									...
									<td align=center class="grid" width="5%"><a href="#" onclick="javascript: addARBDetails();" title="Add Item"><img src="images/icons/add-2.png" width=18 height=18 style="vertical-align: middle;" /></a></td>
								</tr>
							<?php } ?>
							</table>
							<table cellpadding=0 cellspacing=0 border=0 width=100% id="begdetails">
								<?php ARDETAILS($_SESSION['company'],$_SESSION['branchid']); ?>
							</table>
						</td>
					</tr>
				</table>
