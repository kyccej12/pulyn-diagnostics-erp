<?php
	...
	mysql_query("update acctg_gl set tmp_cleared='N' where tmp_cleared='Y' and acct = '$_REQUEST[acct_code]' and branch = '1';");
	
	$date = formatDate($_POST['xdate']);
	
	$cleared_d8 = mysql_fetch_array(mysql_query("select distinct cleared_on from acctg_gl where cleared_on < '$date' and acct = '$_POST[acct_code]' and branch = '1' order by cleared_on desc limit 1;"));
