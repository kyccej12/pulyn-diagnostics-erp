	...
	<tr>
		<td  style="padding:0px;" valign=top>
			...
			<table width="100%"  cellspacing="0" cellpadding="0" style="padding-left: 5px;">
				...
				<tr>
					<td>
						<button onClick="parent.showEInfo('');" class="buttonding"><img src="images/icons/adduser.png" width=24 height=24 align=absmiddle />&nbsp;&nbsp;New Employee Record</b></button>
						...
						<button onClick="javascript: show201();" class="buttonding"><img src="images/icons/customerinfo.png" width=24 height=24 align=absmiddle />&nbsp;&nbsp;Employee 201 File</b></button>
						<button onClick="javascript: parent.showEmployees();" class="buttonding"><img src="images/icons/refresh.png" width=24 height=24 align=absmiddle />&nbsp;&nbsp;Reload List</b></button>
