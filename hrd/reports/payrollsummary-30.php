...
<table width="100%">
	<tr>
		...
		<td align=right><span style="font-size: 7pt;"><b>PAYROLL REGISTER</b><br />Cutoff Perioed: '. $fDates[0] . '-' . $fDates[1] . '</span></td>
	</tr>
</table>
</htmlpageheader>
...
<thead>
	<tr style="background-color: #cdcdcd; font-weight: bold;">
		...
		<td align=center><b>OTLH<br/>(REG+EX)</b></td>
		...
		<td align=center><b>SSS<br/>PREM</b></td>
		<td align=center><b>RET.<br/>PLAN</b></td>
		<td align=center><b>COOP<br/>PREM</b></td>
		<td align=center><b>WTAX</b></td>
		<td align=center><b>SSS<br/>LOAN</b></td>
		<td align=center><b>C.A</b></td>
		<td align=center><b>EQUICOM</b></td>
...
<tbody>';
	...
	while($row = $a->fetch_array(MYSQLI_BOTH)) {
		...
		$dedTotal = $row['sss_premium'] + $row['wtax'] + $row['sss_loan'] + $row['cash_adv'] + $row['equicom'] + $row['coop_loan'] + $row['health_ins'] + $row['retirement_plan'] + $row['other_loans'] + $row['others_total'];	
		
		$html = $html . '<tr>
			<td align="left">' . $row['emp_id'] . '</td>
			<td align="left">' . $row['emp_name'] . '</td>
			<td align="left">' . $row['acct_no'] . '</td>
			<td align="left">' . $desg . '</td>
			<td align="right">' . number_format($row['basic_day'],2) . '</td>
			<td align="right">' . number_format($basicPay,2) . '</td>
			<td align="right">(' . number_format($row['absences'],2) . ')</td>
			<td align="right">(' . number_format($row['late'],2) . ')</td>
			<td align="right">(' . number_format($row['undertime'],2) . ')</td>
			...
			<td align="right">' . number_format($otLH,2) . '</td>
			<td align="right">' . number_format($otSH,2) . '</td>
			...
			<td align="right">' . number_format($row['retirement_plan'],2) . '</td>
			<td align="right">' . number_format($row['coop_premium'],2) . '</td>
			<td align="right">' . number_format($row['wtax'],2) . '</td>
			<td align="right">' . number_format($row['sss_loan'],2) . '</td>
			<td align="right">' . number_format($row['cash_adv'],2) . '</td>
			<td align="right">' . number_format($row['equicom'],2) . '</td>
			<td align="right">' . number_format($row['coop_loan'],2) . '</td>
			<td align="right">' . number_format($row['health_ins'],2) . '</td>
			<td align="right">' . number_format($row['other_loans'],2) . '</td>
			<td align="right">' . number_format($row['others_total'],2) . '</td>
			<td align="right">' . number_format($dedTotal,2) . '</td>
			<td align="right">' . number_format($row['net_pay'],2) . '</td>
			<td align=center>'.$row['on_hold'].'</td>
			<td align="right">' . number_format($cash,2) . '</td>
			<td align="right">' . number_format($atm,2) . '</td>
		</tr>';
			...
			$sssGT+=$row['sss_premium'];
			$wtaxGT+=$row['wtax'];
			$ssloanGT+=$row['sss_loan'];
			$caGT+=$row['cash_adv'];
			$equicomGT+=$row['equicom'];
			$cooploanGT+=$row['coop_loan'];
			$hinsGT+=$row['health_ins'];
			$retGT+=$row['retirement_plan'];
			$cooppGT+=$row['coop_premium'];
	...
	$html .= '<tr style="background-color: #cdcdcd; font-weight: bold;">
		<td align="left" colspan=5>GRAND TOTAL</td>
		...
		<td align="right" style="font-weight: bold;">' . number_format($slGT,2) . '</td>
		...
		<td align="right" style="font-weight: bold;">' . number_format($sssGT,2) . '</td>
		<td align="right" style="font-weight: bold;">' . number_format($retGT,2) . '</td>
		<td align="right" style="font-weight: bold;">' . number_format($cooppGT,2) . '</td>
		<td align="right" style="font-weight: bold;">' . number_format($wtaxGT,2) . '</td>
		<td align="right" style="font-weight: bold;">' . number_format($ssloanGT,2) . '</td>
		<td align="right" style="font-weight: bold;">' . number_format($caGT,2) . '</td>
		<td align="right" style="font-weight: bold;">' . number_format($equicomGT,2) . '</td>
...
if($_GET['proj'] != '1') {
	...
	$html .= '<table style="font-size: 5pt; margin-top: 50px;" cellpadding=20 cellspacing=0 align=left>
		<tr>
			<td>Prepared By:  _________________________<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Ronave Redulla</td>
			<td>Checked By:  _____________________________________________<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Maria Lidonna Gabuyan (HR Supervisor)</td>
			<td>Noted By:  _____________________________________<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Josie Magno (Finance Manager)</td>
			<td>Noted By:  ___________________________________________<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Miles B. Albacite (General Manager)</td>
			<td>Approved By:  _____________________________________<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Elicer C. Murcia (VP - Operations)</td>
			<td>Approved By:  _____________________________________<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Ronald Y. Elpa (President & CEO)</td>
		<tr>
	</table>';

} else {
	
	$html .= '<table style="font-size: 5pt; margin-top: 50px;" cellpadding=50 cellspacing=0 align=left>
		<tr>
			<td>Noted By:  _____________________________________<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Josie Magno (Finance Manager)</td>
			<td>Noted By:  ___________________________________________<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Miles B. Albacite (General Manager)</td>
			<td>Approved By:  _____________________________________<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Elicer C. Murcia (VP - Operations)</td>
