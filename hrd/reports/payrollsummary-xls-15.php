<?php
	...
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue("Y6","HDMF PREM");
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue("Z6","PHIC");
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue("AA6","HDMF LOAN");
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue("AB6","CA");
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue("AC6","EQUICOM");
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue("AD6","COOP LOAN");
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue("AE6","HEALTH INS.");
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue("AF6","OTHER LOANS");
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue("AG6","OTHER DED.");
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue("AH6","TOTAL DED.");
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue("AI6","NET PAY");
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue("AJ6","ON HOLD");
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue("AK6","ON CASH");
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue("AL6","ON ATM");
	...
	while($data2 = $a->fetch_array()) {
		...
		$dedTotal = $data2['pagibig_premium'] + $data2['philhealth_premium'] + $data2['coop_premium'] + $data2['retirement_plan'] + $data2['wtax'] + $data2['hdmf_loan'] + $data2['cash_adv'] + $data2['equicom'] + $data2['coop_loan'] + $data2['health_ins'] + $data2['other_loans'] + $data2['others_total'];
		...
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(24,$row,$data2['pagibig_premium']);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(25,$row,$data2['philhealth_premium']);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(26,$row,$data2['hdmf_loan']);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(27,$row,$data2['cash_adv']);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(28,$row,$data2['equicom']);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(29,$row,$data2['coop_loan']);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(30,$row,$data2['health_ins']);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(31,$row,$data2['other_loans']);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(32,$row,$data2['others_total']);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(33,$row,$dedTotal);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(34,$row,$data2['net_pay']);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(35,$row,$data2['on_hold']);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(36,$row,$cash);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(37,$row,$atm);
		for($y = 0; $y <= 37; $y++) { $objPHPExcel->getActiveSheet()->getStyleByColumnAndRow($y,$row)->applyFromArray($contentStyle); }
		for($z = 4; $z <= 37; $z++) { if($z!=35) { $objPHPExcel->getActiveSheet()->getStyleByColumnAndRow($z,$row)->getNumberFormat()->setFormatCode('#,##0.00'); }}
		...
		$hdmfGT+=$data2['pagibig_premium'];
		$phicGT+=$data2['philhealth_premium'];
		$hdloanGT+=$data2['hdmf_loan'];
		$caGT+=$data2['cash_adv'];
	...
	$objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(24,$row,$hdmfGT);
	$objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(25,$row,$phicGT);
	$objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(26,$row,$hdloanGT);
	$objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(27,$row,$caGT);
	$objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(28,$row,$equicomGT);
	$objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(29,$row,$cooploanGT);
	$objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(30,$row,$hinsGT);
	$objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(31,$row,$otherLoansGT);
	$objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(32,$row,$othersGT);
	$objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(33,$row,$dedTotalGT);
	$objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(34,$row,$netGT);
	$objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(36,$row,$cashGT);
	$objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(37,$row,$atmGT);
	
	for($y = 5; $y <= 37; $y++) { $objPHPExcel->getActiveSheet()->getStyleByColumnAndRow($y,$row)->applyFromArray($totalStyle); }
	for($z = 5; $z <= 37; $z++) { if($z!=35) { $objPHPExcel->getActiveSheet()->getStyleByColumnAndRow($z,$row)->getNumberFormat()->setFormatCode('#,##0.00'); }}
	...
	header('Content-Disposition: attachment;filename="payregister-15.xlsx"');
