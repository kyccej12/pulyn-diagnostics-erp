<?php 
	...
	$o = new _init;
	if(isset($_SESSION['authkey'])) { $exception = $o->validateKey(); if($o->exception != 0) {	$URL = $HTTP_REFERER . "login/index_clinic.php?exception=" . $o->exception; } } else { $URL = $HTTP_REFERER . "login"; }
...
<head>
	...
	<title>Opon Medical Diagnostics Incorporated</title>
...
<body bgcolor="#ffffff" leftmargin="0" bottommargin="0" rightmargin="0" topmargin="0" <?php if($o->cpass == 'Y') { echo "onLoad=\"showChangePass();\""; } ?> style="background: url(images/wallpaper-5.jpg); background-size: 100% 100%; background-repeat: no-repeat;">
 <table height="100%" width="100%" border="0" cellspacing="0" cellpadding="0" >
	<tr>
		...
		<td align=right style="height:37px; padding-right: 5px; background-color:#595959; background-image: url(images/4.png);"><img src="images/icons/user.png" align=absmiddle border=0 width=18 height=18 /><span style="font-size: 11px; font-weight: bold; color: #ffffff;">&nbsp;<?php if($_SESSION['clinic_no'] == '1') echo "Clinic 1 &raquo;"; ?><?php if($_SESSION['clinic_no'] == '2') echo "Clinic 2 &raquo;"; ?><?php if($_SESSION['clinic_no'] == '3') echo "Clinic 3 &raquo;"; ?><?php if($_SESSION['clinic_no'] == '4') echo "Clinic 4 &raquo;"; ?><?php if($_SESSION['clinic_no'] == 'Medical Director') echo "Medical Director &raquo;"; ?>&nbsp;<?php if($_SESSION['type'] == '1') echo "Medical Examiner &raquo;"; ?>&nbsp;<?php if($_SESSION['type'] == '2') echo "Medical Evaluator &raquo;"; ?>&nbsp;<?php $o->getUname($_SESSION['userid']); ?>&nbsp;&nbsp;&nbsp;|</span>&nbsp;<a href="logout_clinic.php" style="font-size: 12px; font-weight: bold; color: #ffffff; text-decoration: none;" title="Click to Logout"><img src="images/button-logout.png" align=absmiddle border=0 width=24 height=24 />Logout</a></td>
	</tr>
	<tr height=90%>
		<td colspan=3>
	...
	<tr>
		<td colspan=3>
			<table width="100%" height="100%" cellpadding=0 cellspacing=0 align="center" valign=middle>
				<tr bgcolor="#363535">
					<td align=center style="font-family: arial, helvetica, sans-serif; color: #fefefe; font-size: 11px; height: 15px; font-weight: bold;">&copy; Exclusively Developed for Opon Medical Diagnostic INc. by Port80 Business Solutions</td>
				</tr>
			</table>
		</td>
	</tr>
