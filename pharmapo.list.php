	...
	<script>
		...
		function viewDocInfo() {
			if(sPO == "") { 
				...
				$.post("pharmapo.datacontrol.php", {mod: "getDocInfo", po_no: sPO, sid: Math.random() }, function(data) { $("#docinfo").html(data); },"html")
		...
		$(document).ready(function() {
			$('#itemlist').dataTable({
				...
				"sAjaxSource": "data/pharmapolist.php?1=1<?php echo $a.$b.$c; ?>",
				"order": [[0,"desc"]],
				"aoColumns": [
				  { mData: 'po' } ,
				  { mData: 'pdate' },
...
<body bgcolor="#ffffff" leftmargin="0" bottommargin="0" rightmargin="0" topmargin="0" >
	<table width=100% cellpadding=0 cellspacing=0 style="padding-left: 5px; margin-bottom: 2px;">
		<tr>
			<td align=left>
				<a href="#" onClick="parent.viewPharmaPO('');" class="topClickers"><img src="images/icons/add.png" width=18 height=18 align=absmiddle />&nbsp;New Purchase Order</a>&nbsp;
				<a href="#" onClick="viewPharmaPO();" class="topClickers"><img src="images/icons/bill.png" width=16 height=16 align=absmiddle />&nbsp;View/Edit P.O</a>&nbsp;
				<a href="#" onClick="parent.showPharmaPOList();" class="topClickers"><img src="images/icons/refresh.png" width=18 height=18 align=absmiddle />&nbsp;Reload List</a>&nbsp;
	...
	<div id="searchDiv" style="display: none;">
		<form name = "frmSearch" id = "frmSearch" method = "POST" action = "pharmapo.list.php">
