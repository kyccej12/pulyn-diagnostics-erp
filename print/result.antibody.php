...
<div id="main">
	<table width=60% cellpadding=0 cellspacing=0 align=center style="margin: 5px;">
        <tr><td align=center><span style="font-size: 12pt; font-weight: bold;">SARS-CoV-2 Antibody DETECTION</span></td></tr>
    </table>
	...
	<table width=80% cellpadding=0 cellspacing=0 align=center style="border-collapse: collapse; font-size: 12px;">
            ...
            <tr>
                <td class="itemResult" width=50%>SARS-CoV-2 ANTIBODY IGM</td>
                <td class="itemResult" width=50%>'.$_ihead['result_igm'].'</td>
            </tr>
            <tr>
                <td class="itemResult" width=50%>SARS-CoV-2 ANTIBODY IGG</td>
                <td class="itemResult" width=50%>'.$_ihead['result_igg'].'</td>
            </tr>
	...
	<table width=80% cellpadding=0 cellspacing=0 align=center style="border-collapse: collapse; font-size: 10px;">
            ...
            <tr>
                <td class="itemRemarks" width=50%>Covid 19 Antibody IgM/IgG Reactive</td>
                <td class="itemRemarks" width=50%>Suspected Infection</td>
            </tr>
			<tr>
                <td class="itemRemarks" width=50%>Covid 19 Antibody IgM/IgG Non- Reactive</td>
	...
	<table width=100% cellpadding=1 cellspacing=0 align=left style="font-style: italic; margin-top: 50px; font-size: 8pt;">
		...
		<tr><td width=100>Performance :</td><td><b>Combined Sensitivity = &nbsp;&nbsp;&nbsp;'.$_ihead['sensitivity'].'&nbsp;%</b></td></tr>
		<tr><td width=100></td><td><b>Combined Specificity = &nbsp;&nbsp;&nbsp;'.$_ihead['specificity'].'&nbsp;%</b></td></tr>
	</table>
