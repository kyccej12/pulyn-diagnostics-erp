...
/* END OF SQL QUERIES */
$mpdf=new mPDF('win-1252','FOLIO-H','','',5,5,5,5,5,51);
...
<body style="background: url('.$file.'); background-repeat: no-repeat;">
...
<table width=100% cellpadding=5>
	<tr>
        ...
        <td valign=top><img src="../images/signatures/zamora_signature2.png" align=absmidddle /></td>
	</tr>
</table>
</htmlpagefooter>
