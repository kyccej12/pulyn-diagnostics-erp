...
/* MYSQL QUERIES SECTION */
    ...
    $b = $con->getArray("SELECT *, hiv_one,hiv_two,hiv_half,created_by,verified_by,verified FROM lab_hiv WHERE so_no = '$_REQUEST[so_no]' and branch = '$_SESSION[branchid]' and serialno = '$_REQUEST[serialno]';");
