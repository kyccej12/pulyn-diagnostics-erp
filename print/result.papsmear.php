...
/* MYSQL QUERIES SECTION */
    ...
    list($file) = $con->getArray("select CONCAT('../',file_path) from lab_samples where so_no = '$_REQUEST[so_no]' and `code` = 'L076' and serialno = '$_REQUEST[serialno]';");
    $b = $con->getArray("SELECT * FROM lab_samples WHERE so_no = '$_REQUEST[so_no]' and `code` = 'L076' and serialno = '$_REQUEST[serialno]';");
    if($b['updated_by'] != '') {
...
$mpdf=new mPDF('c','LEETER','','',5,5,5,5,5,51);
