<?php	
	...
	if(isset($_REQUEST['rr_no']) && $_REQUEST['rr_no'] != '') {  
		$res = $p->getArray("select *, lpad(rr_no,6,0) as rrno, lpad(supplier,6,0) as sup_code, date_format(rr_date,'%m/%d/%Y') as d8, date_format(invoice_date,'%m/%d/%Y') as id8 from rr_header where rr_no='$_REQUEST[rr_no]' and branch = '1';");
...
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
	...
	<script language="javascript" src="js/rr.js"></script>
	<script>
		...
		function redrawDataTable() {
			$('#details').DataTable().ajax.url("rr.datacontrol.php?mod=retrieve&trace_no=<?php echo $trace_no; ?>").load();
		}
	</script>
</head>
			...
			<tr>
				<td align=left colspan=2 style="padding-top: 15px;">
					<?php if($status == 'Active') { ?>
						...
						<a href="#" class="topClickers" onClick="javascript:deleteItem();"><img src="images/icons/delete.png" width=16 height=16 border=0 align="absmiddle">&nbsp;Remove Line Entries</a>&nbsp;&nbsp;
