...
<body bgcolor="#ffffff" leftmargin="0" bottommargin="0" rightmargin="0" topmargin="0" >
	...
	<table width=100% cellpadding=5 cellspacing=0>
		<tr>
			<td align=left>
				<a href="#" onClick="parent.viewSOA('');" class="topClickers"><img src="images/icons/add.png" width=18 height=18 align=absmiddle />&nbsp;New Record</b></a>&nbsp;
				<a href="#" onClick="viewSOA();" class="topClickers"><img src="images/icons/bill.png" width=16 height=16 align=absmiddle />&nbsp;View/Edit Record</b></button>&nbsp;
				<a href="#" onClick="parent.showSOA();" class="topClickers"><img src="images/icons/refresh.png" width=16 height=16 align=absmiddle />&nbsp;Reload List</b></button>&nbsp;
			</td>
		</tr>
	</table>
