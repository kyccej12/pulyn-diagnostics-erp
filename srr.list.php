...
<head>
	...
	<script>
		...
		function refresh() {
			$("#itemlist").DataTable().ajax.url("data/srrlist.php?sid="+Math.random()+"").load();
		}
	</script>
	<style>
		.dataTables_wrapper {
	...
	<table width=100% cellpadding=0 cellspacing=0 style="padding-left: 5px; margin-bottom: 2px;">
		<tr>
			<td align=left>
				...
				<a href="#" onClick="refresh();" class="topClickers"><img src="images/icons/refresh.png" width=16 height=16 align=absmiddle />&nbsp;&nbsp;Reload List</a>
			</td>
		</tr>
	</table>
